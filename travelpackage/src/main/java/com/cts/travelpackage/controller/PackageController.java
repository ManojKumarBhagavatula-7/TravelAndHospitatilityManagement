...
public class PackageController {
	 ...
	 */
	@PostMapping
	public ResponseEntity<TravelPackageDto> createPackage(@RequestBody TravelPackageDto travelpackageDto) {
	 ...
	 */
	@PutMapping("/{id}")
	public ResponseEntity<TravelPackageDto> updatePackageById(@PathVariable(name="id") Long id,@RequestBody  TravelPackageDto travelPackageDto) {
